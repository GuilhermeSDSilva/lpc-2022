...
def inicio():
    ...
    while True:
        ...
        if vitoria != 15 :
            ...
            #blocos
            bloco4 = pygame.draw.rect(tela,"white",(50+x4,10,80,10))
            bloco2 = pygame.draw.rect(tela,"white",(250+x2,10,80,10))
            bloco3 = pygame.draw.rect(tela,"white",(450+x3,10,80,10))
            bloco1 = pygame.draw.rect(tela,"white",(140+x1,30,80,10))
            bloco5 = pygame.draw.rect(tela,"white",(340+x5,30,80,10))
            bloco6 = pygame.draw.rect(tela,"white",(540+x6,30,80,10))
            bloco7 = pygame.draw.rect(tela,"white",(50+x7,50,80,10))
            bloco8 = pygame.draw.rect(tela,"white",(250+x8,50,80,10))
            bloco9 = pygame.draw.rect(tela,"white",(450+x9,50,80,10))
            bloco10 = pygame.draw.rect(tela,"white",(140+x10,70,80,10))
            bloco11 = pygame.draw.rect(tela,"white",(340+x11,70,80,10))
            bloco12 = pygame.draw.rect(tela,"white",(540+x12,70,80,10))
            bloco13 = pygame.draw.rect(tela,"white",(50+x13,90,80,10))
            bloco14 = pygame.draw.rect(tela,"white",(250+x14,90,80,10))
            bloco15 = pygame.draw.rect(tela,"white",(450+x15,90,80,10))
